...
// tagging
static const char *tags[] = {"崔", "二", "三", "四", "五", "六", "七", "八", "九"};
...
static const Rule rules[] = {
    ...
    {"flameshot", NULL, NULL, 0, 1, -1}, // float
    {"SimpleScreenRecorder", NULL, NULL, 1 << 8, 1, -1},
    {"qBittorrent", NULL, NULL, 1 << 8, 0, -1}};
    // {"baidunetdisk", NULL, NULL, 1 << 8, 1, -1}};
...
static Key keys[] = {
    ...
    {MODKEY, XK_a, spawn, SHCMD("android-studio")},
    {0, XK_Print, spawn, SHCMD("flameshot gui")},
    {MODKEY | ShiftMask, XK_l, spawn, SHCMD("i3lock -i ~/data/picture/wallpaper/lockscreen.png")},
